...
// 1782452242984 is replaced by vite at build time so every deploy busts the cache (both comment and CACHE_VERSION).
const CACHE_VERSION = "kaobuddy-1782452242984";
